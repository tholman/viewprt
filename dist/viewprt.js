...
var ViewportObserver = function () {
  function ViewportObserver() {
    ...
    classCallCheck(this, ViewportObserver);
...
function isElementInViewport(element) {
  ...
  var viewportHeight = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : window.innerHeight;
...
var ViewportElementObserver = function (_ViewportObserver) {
  inherits(ViewportElementObserver, _ViewportObserver);

  function ViewportElementObserver() {
    var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    classCallCheck(this, ViewportElementObserver);

    var _this = possibleConstructorReturn(this, _ViewportObserver.call(this, opts));
    ...
    for (id in queue) {
      if (queue.hasOwnProperty(id)) {
        ...
        if (!element || !element.parentNode) {
          this.removeById(id);
        } else if (isElementInViewport(element, this.offset, viewportWidth, viewportHeight)) {
          this.onEnteredViewport(item);
          this.removeById(id);
        }
      }
...
var ViewportPositionObserver = function (_ViewportObserver) {
  inherits(ViewportPositionObserver, _ViewportObserver);

  function ViewportPositionObserver() {
    var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    classCallCheck(this, ViewportPositionObserver);
